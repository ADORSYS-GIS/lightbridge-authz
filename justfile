...
# `day_seat_grain_it_tests` -- #570/#578/#528/#582/#583) run against this SAME
...
# Timescale-specific behavior and run for real.
 ...
 # day_seat_grain_it_tests must itself report >0 passed), not an aggregate total -- an aggregate
