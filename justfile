...
# `spend_query_it_tests`, `scope_ownership_it_tests`, `execution_grain_it_tests` -- #570/#578/#582)
...
# scope_ownership_it_tests/execution_grain_it_tests must itself report >0 passed), not an
# aggregate total -- an aggregate
